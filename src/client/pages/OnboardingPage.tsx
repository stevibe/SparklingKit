    ...
    <div className="onboarding-shell">
      ...
      <section className="onboarding-content onboarding-setup">
        ...
        {tab !== "manual" ? <div className="onboarding-tab-panel" role="tabpanel">
          ...
          <p className="onboarding-script-note">The hosted one-liner verifies the release bundle checksum and never installs Docker itself. Choose GitHub source if you prefer to inspect the files first.</p>
