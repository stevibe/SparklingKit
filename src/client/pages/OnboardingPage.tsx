...
const hostedInstallCommand = `curl -fsSLO https://run.sparklingkit.com/dgx/stable/install.sh
less install.sh
    ...
    <div className="onboarding-shell">
      ...
      <section className="onboarding-content onboarding-setup">
        ...
        {tab !== "manual" ? <div className="onboarding-tab-panel" role="tabpanel">
          ...
          <p className="onboarding-script-note">Download and inspect hosted scripts before running them. The installer verifies the release bundle checksum and never installs Docker itself.</p>
